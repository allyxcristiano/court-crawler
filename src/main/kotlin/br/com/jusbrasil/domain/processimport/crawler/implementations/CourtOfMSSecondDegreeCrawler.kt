...
class CourtOfMSSecondDegreeCrawler(
    ...
    override fun urlOfPage() = environmentConfiguration.courtOfMSUrlSecondDegree
    ...
    override fun pathOfProcessData(): String {
        return "/html/body/div[1]/table[4]/tbody/tr/td/div[1]/table[2]/tbody"
    }
