...
class CourtOfALFirstDegreeCrawler(
    ...
    override fun urlOfPage() = environmentConfiguration.courtOfALUrlFirstDegree
    ...
    override fun pathOfLabelProcessData() =
        "/html/body/div[1]/table[4]/tbody/tr/td/div[1]/table[1]/tbody/tr/td[1]/h2"

    override fun pathOfLabelProcessNotFound() = "/html/body/table[4]/tbody/tr/td/div[1]/table[1]/tbody/tr[2]/td[2]/li"

    override fun idOfLinkToExpandParts() = """linkpartes"""

    override fun idOfLinkToExpandProcessHistory() = """linkmovimentacoes"""

    override fun pathOfProcessData() = "/html/body/div[1]/table[4]/tbody/tr/td/div[1]"
